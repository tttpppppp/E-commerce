...
public class VnPayLibrary
{
    ...
    public string GetIpAddress(HttpContextBase context)
    {
        ...
        try
        {
            // Check for the 'REMOTE_ADDR' server variable
            ipAddress = context.Request.ServerVariables["REMOTE_ADDR"];

            // In case of a proxy server, you might get the real IP in the 'HTTP_X_FORWARDED_FOR' header
        ...
        {
            // Handle any errors, possibly log them
            return ex.Message;
        }
